...
public:
    ...
    void setupUi(QWidget *SubWidget)
    {
        ...
        SubWidget->resize(1200, 750);
        SubWidget->setMinimumSize(QSize(1200, 750));
        SubWidget->setStyleSheet(QStringLiteral(""));
        widget_4 = new QWidget(SubWidget);
        widget_4->setObjectName(QStringLiteral("widget_4"));
        widget_4->setGeometry(QRect(0, 180, 1200, 370));
        widget_4->setMinimumSize(QSize(1200, 370));
        widget_4->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/grey.png);"));
        layoutWidget = new QWidget(SubWidget);
        ...
        widget->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/1.png);"));
        ...
        widget_2->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/2.png);"));
        ...
        widget_3->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/3.png);"));
        ...
        back->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/back.png);"));
        ...
        b1->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/b1.png);"));
        ...
        b2->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/b2.png);"));
        ...
        b3->setStyleSheet(QStringLiteral("border-image: url(:/images/images/levels/b3.png);"));
    ...
    {
        SubWidget->setWindowTitle(QApplication::translate("SubWidget", "Form", nullptr));
