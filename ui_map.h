...
""));
        ...
        start->setStyleSheet(QString::fromUtf8("border-image: url(:/images/images/maps/start.png);"));
        ...
        backsub->setStyleSheet(QString::fromUtf8("border-image: url(:/images/images/maps/back.png);"));
        ...
        life->setStyleSheet(QString::fromUtf8("border-image: url(:/images/images/maps/life.png);"));
        ...
        money->setStyleSheet(QString::fromUtf8("border-image: url(:/images/images/maps/money.png);"));
        ...
        wave->setStyleSheet(QString::fromUtf8("border-image: url(:/images/images/maps/waves.png);"));
